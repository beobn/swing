...
public class DBConnection {//Lớp này giải quyết kết nối xử lý truy vấn
    ...
    private static String hostName = "4.194.5.90";
    private static String acc = "sa";
    private static String pass = "Ducnv_25092002";
    private static String dbName = "asm";
    private static String connectionSql
            = "jdbc:sqlserver://" + hostName + ":1433;databaseName=" + dbName+";encrypt=false";
